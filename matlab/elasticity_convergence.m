...
close all
  ...
  file1 = fopen('linearElasticityBasic_errorsL2','r');
  file2 = fopen('linearElasticityBasic_errorsH1','r');

for i=1:5
  test1 = fscanf(file1, '%[qwertyuioplkjhgfdsazxcvbnm01]');
  test2 = fscanf(file2, '%[qwertyuioplkjhgfdsazxcvbnm01]');
