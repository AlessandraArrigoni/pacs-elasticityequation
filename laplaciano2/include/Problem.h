//classe per la gestione del laplaciano
...
public:
	 Problem ( const GetPot& dataFile, Bulk* bulk1=NULL , Bulk* bulk2=NULL);
         ...
         int index_inside(size_type k, std::vector<long unsigned int>& vec);
 ...
 private:
    ...
    scalarVectorPtr_Type M_uSol, M_uSol1, M_uSol2, M_uSol_new;
