...
Problem::Problem (const GetPot& dataFile, Bulk* bulk1, Bulk* bulk2):
			...
			M_BC1(dataFile, "elasticity1/", "bulkData/"), // change the dataFile accordingly and set it
			M_BC2(dataFile, "elasticity2/", "bulkData/"), // change the dataFile accordingly and set it
			interfaceIdx1( dataFile(std::string("bulkData/elasticity1/interfaceIdx").data(),1) ),// change the dataFile accordingly and set it: devo capire come leggere il valore direttamente dal file!
			interfaceIdx2( dataFile(std::string("bulkData/elasticity2/interfaceIdx").data(),3)), // adesso le ho messe brutali così, poi andranno lette da file o altro. // adesso le ho messe brutali così, poi andranno lette da file o altro.
			M_uFEM1( bulk1->getMesh(), dataFile, "femspaces/", "Sol", "bulkData/", 2),// the last parameter is the dimesion of the space (2 = vector)
			M_uFEM2( bulk2->getMesh(), dataFile, "femspaces/", "Sol", "bulkData/", 2),// the last parameter is the dimesion of the space (2 = vector)
