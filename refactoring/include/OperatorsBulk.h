...
void jump(scalarVectorPtr_Type V, const FEM& FemSol, BulkDatum& Jump); // Compute the jump in all the dofs of FemSol and saves the values in V
// da sottolineare nel report che abbiamo lasciato scalarVectorPtr_Type per uniformarci alle altre funzioni, ma si potrebbero cambiare tutte con le reference
