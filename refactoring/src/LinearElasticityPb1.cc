...
LinearElasticityPb1::LinearElasticityPb1( GetPot const & dataFile, Bulk  & bulk1, Bulk & bulk2, LinearSystem & extSys):
  Method1(dataFile, "elasticity", bulk1, bulk2, LinearElasticityPb1::Qdim, extSys),
  ...
  {
    std::cout<<"Created derived class LinearElasticityPb1\n"<<std::endl;
  }


void LinearElasticityPb1::assembleMatrix()
{
