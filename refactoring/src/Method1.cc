...
Method1::Method1(GetPot const & dataFile, std::string const problem, Bulk & bulk1, Bulk & bulk2, const size_type dim, LinearSystem & extSys):
Problem(dataFile, problem, bulk1, bulk2, dim, extSys) {}


void Method1::assembleRHS()
{
...
void Method1::enforceStrongBC(size_type const domainIdx)
{
