#include "../include/LaplacianPb1.h"


LaplacianPb1::LaplacianPb1 (const GetPot& dataFile, Bulk & bulk1, Bulk & bulk2, LinearSystem & extSys):
  Method1(dataFile, "laplacian", bulk1, bulk2, LaplacianPb1::Qdim, extSys ),
  diff1(dataFile, "bulkData/", "laplacian", "1", "diff"),
  diff2(dataFile, "bulkData/", "laplacian", "2", "diff")
  {
    std::cout<<"Created derived class LaplacianPb1\n"<<std::endl;
  }


void LaplacianPb1::assembleMatrix()
{
