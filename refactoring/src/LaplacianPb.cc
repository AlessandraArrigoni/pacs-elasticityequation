#include "../include/LaplacianPb.h"


LaplacianPb::LaplacianPb (const GetPot& dataFile, Bulk & bulk1, Bulk & bulk2, LinearSystem & extSys):
  Problem(dataFile, "laplacian", bulk1, bulk2, LaplacianPb::Qdim, extSys ),
  diff1(dataFile, "bulkData/", "laplacian", "1", "diff"),
  diff2(dataFile, "bulkData/", "laplacian", "2", "diff")
  {
    std::cout<<"Created derived class LaplacianPb\n"<<std::endl;
  }


void LaplacianPb::assembleMatrix()
{
